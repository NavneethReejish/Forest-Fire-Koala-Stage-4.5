...
function draw() {
   ...
   let display = touches.length + ' touches';
    ...
    if (gameState === INFO) {
        ...
        if (gameState === INFO && pg2Button.visible === true && mousePressedOver(pg2Button) || gameState === INFO && pg2Button.visible === true && touches) {
            gameState = INFO2;
        }
        ...
        if (gameState === INFO2 && pg1Button.visible === true && mousePressedOver(pg1Button) || gameState === INFO2 && pg1Button.visible === true && touches) {
            gameState = INFO;
        }

        if (gameState === INFO2 && pg2Button.visible === true && mousePressedOver(pg2Button) || gameState === INFO2 && pg2Button.visible === true && touches) {
            gameState = INFO2;
        }

        if (gameState === INFO2 && pg3Button.visible === true && mousePressedOver(pg3Button) || gameState === INFO2 && pg3Button.visible === true && touches) {
            gameState = INFO3;
        }
